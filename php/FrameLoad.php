...
class FrameLoad
{
    ...
    function siteFrame() {
        ...
        $html .= "<a href='./phase2/PowerQuery/index.html' class='project-links' target='_blank' >Phase Two</a>";
        $html .= "<a href='#' class='project-links' target='_self' onclick='loadSite(\"page-content\", 13, this);'>Phase Three</a>";
        $html .= "<a href='./phase4/PowerQuery/index.php' class='project-links' target='_blank' >Final</a>";
        $html .= "</div>";
        $html .= "</div>";
